d3.dsv(';', '147_18-24_agosto20.csv', d3.autoType).then(data => {
  ...
  let datafiltered = data.filter((d => d.domicilio_barrio == 'VILLA URQUIZA' || d.domicilio_barrio == 'VILLA PUEYRREDON' || d.domicilio_barrio == 'CABALLITO' || d.domicilio_barrio == 'BARRACAS')) //&& (d => d.canal == 'App BA 147' || d.canal == 'GCS Web'|| d.canal == 'Operador UGIS'|| d.canal == 'App Denuncia Vial'))
  ...
  let chart = Plot.plot({
    ...
    color: {
      legend: true,
      range: ['#236865','#2BA193','#8AB37F','#E9C46A','#E55E3D','#E24D28','#E76F51','#E24D28']
    },
    marks: [
